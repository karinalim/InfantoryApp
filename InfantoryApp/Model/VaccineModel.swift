...
struct Vaccine {
    ...
    static func generateVaccine() -> [Vaccine] {
        return [
            Vaccine(id : 0, moonId: 0, name: "HepB-1", icon: "iconHepatitisB", description: getHBdesc()),
            Vaccine(id : 1, moonId: 1, name: "BCG", icon: "iconBCG", description: getBCGdesc()),
            Vaccine(id : 2, moonId: 1, name: "Polio 1", icon: "iconPolio", description: getPolioDesc()),
            Vaccine(id : 3, moonId: 2, name: "HepB-2", icon: "iconHepatitisB", description: getHBdesc()),
            Vaccine(id : 4, moonId: 2, name: "Polio 2", icon: "iconPolio", description: getHBdesc()),
            Vaccine(id : 5, moonId: 2, name: "DTaP-1", icon: "iconDTP", description: getDPTdesc()),
            Vaccine(id : 6, moonId: 2, name: "Hib", icon: "iconHib", description:getHibDesc()),
            Vaccine(id : 7, moonId: 2, name: "PCV", icon: "iconPCV", description: getPCVdesc()),
            Vaccine(id : 8, moonId: 2, name: "Rotavirus Monovalent", icon: "iconRotaMono", description: getRotaMonoDesc()),
            Vaccine(id : 9, moonId: 3, name: "HepB-3", icon: "iconHepatitisB", description: getHBdesc()),
            Vaccine(id : 10, moonId: 3, name: "Polio 3", icon: "iconPolio", description: getHBdesc()),
            Vaccine(id : 11, moonId: 3, name: "DTaP-2", icon: "iconDTP", description: getDPTdesc()),
            Vaccine(id : 12, moonId: 3, name: "Hib", icon: "iconHib", description:getHibDesc()),
            Vaccine(id : 13, moonId: 4, name: "HepB-4", icon: "iconHepatitisB", description: getHBdesc()),
            Vaccine(id : 14, moonId: 4, name: "Polio 3", icon: "iconPolio", description: getHBdesc()),
            Vaccine(id : 15, moonId: 4, name: "DTaP-3", icon: "iconDTP", description: getDPTdesc()),
            Vaccine(id : 16, moonId: 4, name: "PCV 2", icon: "iconPCV", description: getPCVdesc()),
            Vaccine(id : 17, moonId: 4, name: "Rotavirus Monovalent 2", icon: "iconRotaMono", description: getRotaMonoDesc()),
            Vaccine(id : 18, moonId: 6, name: "PCV 3", icon: "iconPCV", description: getPCVdesc()),
            Vaccine(id : 19, moonId: 6, name: "Rotavirus Pentavalent 1", icon: "iconRotaMono", description: getRotaPentaDesc()),
            Vaccine(id : 20, moonId: 6, name: "Influenza", icon: "iconFlu", description: getFluDesc()),
            Vaccine(id : 21, moonId: 9, name: "MR", icon: "iconMR", description: getMRdesc()),
            Vaccine(id : 22, moonId: 9, name: "JE", icon: "iconJE", description: getJEdesc()),
            Vaccine(id : 23, moonId: 11, name: "PCV 4", icon: "iconPCV", description: getDPTdesc()),
            Vaccine(id : 24, moonId: 12, name: "JE", icon: "iconJE", description: getJEdesc()),
        ]
    }
